    ...
    <div class="content" id="app">
        <div class="contact-wrapper animated bounceInUp">
            <div class="contact-form">
                <h3>Iniciar Sesion Como Cliente</h3>
                <form action="">
                    <p>
                    ...
                    <p class="block">
                        <button type="button" @click="enviarFor" value="Registrar"> Iniciar Sesion </button>
                    </p>
            ...
            <div class="contact-info">
                ...
                <p class="block">
                    <a href="loginclie.php"><button type="button" value="Registrar"> Iniciar Sesion como cliente </button></a>
                </p>
            </div>
        </div>
    </div>
    ...
    var app = new Vue({
        ...
        methods:{
			enviarFor:function(){
				...
				axios.post('controller/iniciarsessioncli.php', params)
                ...
                .then((response) => {
					...
					if(response.data.acceso){
						window.location="Reservarcitas.php";
            }
				})
