...
Where citas.cliente=clientes.id_cliente And citas.empleado=empleados.id_empleados And citas.servicio=servicios.id_servicio
And empleados.nombre ='Vanessa Vera Luis'";
