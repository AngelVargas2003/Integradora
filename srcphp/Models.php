<?php
    ...
    methods:{
        enviardatos:function(){
            ...
            params.append('nombre', this.cliente.nombre);
            params.append('direccion', this.cliente.direccion);
            params.append('correo', this.cliente.correo);
            params.append('telefono', this.cliente.telefono);

            axios.post('/generarcliente.php', params)
